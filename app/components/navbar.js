export default function Footer(current_page) {
    return (
        <nav class="backdrop-blur-sm fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 h-24">
          <a href="/" class="flex items-center">
            <img src="https://raw.githubusercontent.com/rollestoncollege/logos/main/logos/light/logo_large64.png" class="h-10 mr-3" alt="Flowbite Logo"></img>
          </a>
          <div class="flex md:order-2">
            <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Our Work</button>
